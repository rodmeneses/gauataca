...
export const HANDOFF_NOTES: { h: Localized; items: Localized[] }[] = [
  ...
  { h: { es: 'Tablas sugeridas', en: 'Suggested tables' }, items: [
    ...
    { es: 'threads(id, author_id, title, body) · thread_reactions(thread_id, profile_id, kind) · thread_comments(thread_id, author_id, body, parent_id) · thread_comment_reactions(comment_id, profile_id, kind) · thread_media(thread_id, comment_id, url) · thread_refs(thread_id, comment_id, ref_kind, ref_id)', en: 'threads(id, author_id, title, body) · thread_reactions(thread_id, profile_id, kind) · thread_comments(thread_id, author_id, body, parent_id) · thread_comment_reactions(comment_id, profile_id, kind) · thread_media(thread_id, comment_id, url) · thread_refs(thread_id, comment_id, ref_kind, ref_id)' },
  ] },
