...
insert into profiles (id, name, email, role, title_es, title_en, joined_at) values
  ...
  ('ce044361-93d2-4ac1-9111-30788790ac3c', 'Rodrigo', 'rmeneses@gmail.com', 'member', null, null, '2026-08-30T22:27:03.745008+00:00')
...
-- Events (11)
-- ---------------------------------------------------------------------------
insert into events (id, type, state, starts_at, venue, fee_cents, attend, flyer_url, title_es, title_en, note_es, note_en, previous_starts_at) values
  ('e3', 'garage', 'active', '2026-08-27T16:00:00Z', 'Hayward, CA', 0, 5, null,
  ...
  ('e2', 'studio', 'active', '2026-09-02T19:00:00Z', 'San Leandro, CA', -5000, 4, null,
  ...
  ('e1', 'gig', 'active', '2026-09-12T18:30:00Z', 'Fruitvale Plaza, Oakland, CA', 60000, 5, 'https://drive.google.com/file/d/dtv-flyer-fruitvale/view',
  ...
  ('e5', 'gig', 'cancelled', '2026-09-19T19:30:00Z', 'San José, CA', 0, 0, null,
  ...
  ('e4', 'gig', 'rescheduled', '2026-10-04T15:00:00Z', 'Palo Alto, CA', 85000, 4, null,
  ...
  ('e6', 'gig', 'active', '2026-12-16T19:00:00Z', 'Oakland, CA', 30000, 5, null,
  ...
  ('h1', 'gig', 'active', '2026-08-15T17:00:00Z', 'Civic Center Park, Berkeley, CA', 45000, 5, null,
