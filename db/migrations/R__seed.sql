...
-- Events (11)
-- ---------------------------------------------------------------------------
insert into events (id, type, state, starts_at, duration_hours, venue, fee_cents, attend, flyer_url, title_es, title_en, note_es, note_en, previous_starts_at) values
  ('e3', 'garage', 'active', '2026-08-27T16:00:00Z', 3, 'Hayward, CA', 0, 5, null,
  ...
  ('e2', 'studio', 'active', '2026-09-02T19:00:00Z', 2, 'San Leandro, CA', -5000, 4, null,
  ...
  ('e1', 'gig', 'active', '2026-09-12T18:30:00Z', 2, 'Fruitvale Plaza, Oakland, CA', 60000, 5, 'https://drive.google.com/file/d/dtv-flyer-fruitvale/view',
  ...
  ('e5', 'gig', 'cancelled', '2026-09-19T19:30:00Z', null, 'San José, CA', 0, 0, null,
  ...
  ('e4', 'gig', 'rescheduled', '2026-10-04T15:00:00Z', 3, 'Palo Alto, CA', 85000, 4, null,
  ...
  ('e6', 'gig', 'active', '2026-12-16T19:00:00Z', 2, 'Oakland, CA', 30000, 5, null,
  ...
  ('h1', 'gig', 'active', '2026-08-15T17:00:00Z', 3, 'Civic Center Park, Berkeley, CA', 45000, 5, null,
